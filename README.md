...
![jusan-logo](https://github.com/Columbia91/TechOrda/blob/main/git/4%20branch/jusan-logo.png?raw=true)
...
### Скрипт "username.sh"
Скрипт `username.sh` выводит мое имя в формате Имя Фамилия.